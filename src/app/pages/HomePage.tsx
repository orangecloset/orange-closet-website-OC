                  ...
                  <>
                    ...
                    <div className={`absolute inset-0 flex ${wideMobile ? "items-end justify-center pb-9" : "items-center justify-center"} sm:items-center sm:justify-start sm:pb-0 sm:pl-16`}>
                      <div className="text-white text-center sm:text-left">
                        {block.hero.label && (
                          <h2 className={`${wideMobile ? "text-3xl" : "text-2xl"} sm:text-3xl lg:text-6xl font-normal tracking-wide mb-2 hero-title-shadow`}>
                            {block.hero.label}
                          </h2>
                        )}
                        {block.hero.subtitle && (
                  ...
                  {(item.label || item.subtitle) && (
                    <>
                      ...
                      <div className="absolute bottom-4 left-5 sm:top-4 sm:bottom-auto">
                        {item.label && (
                          <h2 className="text-white text-2xl lg:text-6xl font-normal mb-1 hero-title-shadow">
                            {item.label}
                          </h2>
                        )}
                        {item.subtitle && (
